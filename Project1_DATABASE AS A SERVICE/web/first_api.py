...
Store a sentence for 1 token
Retrieve his stored sentences on out database for 1 token
...
class Register(Resource):
    def post(self):
        ...
        #Hash(password + salt) = wdgshjajksk123145snj
...
class Store(Resource):
    def post(self):
        ...
        if num_tokens <= 0:
            ...
            return jsonify(retJson)
        #step 5 store the sentence and take one token away return 200
        users.update({
            "Username":username
        }, {
            "$set":{
